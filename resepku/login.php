...
<body class="bg-[#0d0b0a] text-neutral-100 min-h-screen antialiased">
    ...
    <div class="min-h-screen flex flex-col lg:flex-row">
        ...
        <!-- Left: Form panel (swapped side vs register, for rhythm) -->
        <div class="flex-1 flex items-center justify-center p-6 sm:p-10 relative order-2 lg:order-1">
            ...
            <div class="w-full max-w-sm relative">
                ...
                <div class="mb-8">
                    <span class="text-xs font-medium uppercase tracking-[0.2em] text-[#c9a15a]">Welcome back</span>
                    <h1 class="font-display text-3xl font-semibold text-white mt-2">Sign in to your table</h1>
                    <p class="text-neutral-500 text-sm mt-2">Your seat's still warm. Let's get you back in.</p>
                </div>
                ...
                <form action="" method="POST" class="space-y-4">
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-1.5">
                            <label for="pass" class="block text-xs font-medium text-neutral-400 tracking-wide">Password</label>
                            <a href="#" class="text-xs text-[#c9a15a] hover:text-[#dab879] transition-colors">Forgot?</a>
                        </div>
                        <input
                            type="password"
                            id="pass"
                ...
                <p class="text-center text-xs text-neutral-500 mt-6">
                    New to Resepku?
                    <a href="register.php" class="text-[#c9a15a] hover:text-[#dab879] font-medium transition-colors">Create an account</a>
                </p>
            </div>
        </div>
            ...
            <div class="relative z-10 h-full flex flex-col justify-between p-12">
                ...
                <div class="max-w-md ml-auto text-right">
                    <h2 class="font-display text-4xl xl:text-5xl font-semibold text-white leading-tight">
                        Pull up a chair.<br> The table's set for you.
                    </h2>
                    <p class="mt-4 text-neutral-300 text-sm leading-relaxed">
                        Sign back in and pick up right where you left off — your recipes
                        are waiting.
                    </p>
                </div>
            </div>
